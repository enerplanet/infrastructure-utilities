...
func New(ctx context.Context,
	...
	// If BaseURL already contains /auth, we should handle it carefully.
	// Standard Keycloak (Quarkus) is /realms/{realm}
	// Older Keycloak (Wildfly) was /auth/realms/{realm}
	...
	providerURL := fmt.Sprintf("%s/realms/%s", baseURL, config.Realm)
